...
defmodule PolyContainer.LSP.Server do
  @moduledoc """
  LSP server implementation for PolyContainer.

  Provides LSP features for container files (Dockerfile, docker-compose.yml).
  """
  use GenLSP

  require Logger

  alias PolyContainer.LSP.Handlers.{Completion, Diagnostics, Hover}
  ...
  def handle_request(%{"method" => "initialize", "params" => params}, lsp) do
    ...
    Logger.info("Initializing PolyContainer LSP for project: #{inspect(project_path)}")
